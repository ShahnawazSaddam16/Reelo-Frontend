...
const API_URL = "http://192.168.100.77:8081/api";
  ...
  try {
    ...
    console.error('Render error in MyProfile', err);
    return (
      <View className="flex-1 items-center justify-center bg-[#0B0B0D] p-6">
        <Text className="text-white mb-4">Something went wrong rendering profile.</Text>
        <Pressable onPress={refreshAll} className="bg-white px-4 py-2 rounded-xl">
