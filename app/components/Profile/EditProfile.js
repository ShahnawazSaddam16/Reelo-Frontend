...
export default function EditProfile({ edit, setEdit, profile, setProfile }) {
  ...
  return (
    <>
      {edit && (
        <View className="absolute inset-0 bg-black/70 justify-center z-50">
          <Pressable className="absolute inset-0" onPress={() => setEdit(false)} />

          <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
            <View className="bg-neutral-950 rounded-t-3xl px-6 pt-0 pb-0 border-t border-purple-500/20">
